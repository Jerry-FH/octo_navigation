...
#include "astar_2d_planner/srv/start_nav.hpp"
...
public:
  ...
  : Node("exe_path")
  {
    ...
    srv_ = create_service<astar_2d_planner::srv::StartNav>(
      "/exe_path/start_nav",
...
private:
  // Service callback
  void onTrigger(const std::shared_ptr<astar_2d_planner::srv::StartNav::Request> req,
                 std::shared_ptr<astar_2d_planner::srv::StartNav::Response>      res)
  {
  ...
  rclcpp::Service<astar_2d_planner::srv::StartNav>::SharedPtr   srv_;
